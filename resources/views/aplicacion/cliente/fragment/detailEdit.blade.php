                ...
                <div class="row">
                    ...
                    <div class="col-md-push-1 col-md-3">
                        <div class="form-group">
                            ...
                            {!! Form::text('fiador2_documento', !$fiador2->isEmpty() ? $fiador2[0]->fiador_documento : null, ['class'=>'form-control not-empty', 'placeholder' =>   'Documento del fiador','onkeyup' => 'camposNumerico(this)', 'onchange' => 'camposNumerico(this)']) !!}
                        </div>
                    </div>
                </div>
